    ...
    <div>
      ...
      <div className="home-body-text" >
        <div className="home-body-text-item">
          <h3>Welcome to Online Quran Academy</h3>
        ...
        <div className="home-body-text-item">
          <h3>Significance of The Holy Quran</h3>
          <h6>“Read! In the name of your Lord, who has created (all that exists)” (Al Quran)</h6>
        ...
        <div className="home-body-text-item">
          <h3>Our Mission</h3>
          <h6>“The best among you is he who learns the Quran and teaches it” (Bukhari)</h6>
        ...
        <div className="home-body-text-item">
          <h3>How Online Quran Classes Work?</h3>
